                        ...
                        <?php foreach ($user_info as $info) { ?>
                            ...
                            <div class="row lables mrgn_top">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <input type="hidden" class="form-control" value="<?php echo $info->access_level; ?>" name="access_level" placeholder="Enter access_level">
                                    <!-- <select class="form-control select2" name="access_level" readonly>
